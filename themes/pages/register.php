...
<body class="vertical-layout vertical-menu-modern blank-page navbar-floating footer-static dark-layout" data-open="click" data-menu="vertical-menu-modern" data-col="blank-page">
    <!-- BEGIN: Content-->
                ...
                <div class="auth-wrapper auth-v2">
                    <div class="auth-inner row m-0">
                        <!-- Brand logo--><a class="brand-logo" href="javascript:void(0);">
                            ...
                            <h2 class="brand-text text-primary ml-1">HMS</h2>
                        </a>
                        <!-- /Brand logo-->
                        <!-- Left Text-->
                        <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
                            <div class="w-100 d-lg-flex align-items-center justify-content-center px-5"><img class="img-fluid" src="assets/images/pages/register-v2.svg" alt="Register V2" /></div>
                        </div>
                        <!-- /Left Text-->
                        <!-- Register-->
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                <h2 class="card-title font-weight-bold mt-5 mt-md-0 mb-1">Register Now. 🚀</h2>
                                <p class="card-text mb-2">Make your hotel booking easy and fun!</p>

                                <form class="auth-register-form mt-2" id="signup-form">
                                    <div id="response"></div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="fullname" type="text" name="fullname" placeholder="John Doe" aria-describedby="register-username" autofocus="" tabindex="1" />
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label" for="phoneno">Phone No</label>
                                        <input class="form-control" id="phoneno" type="text" name="phoneno" placeholder="+91xxxxxxxxxx" aria-describedby="register-username" autofocus="" tabindex="1" />
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="roleid" name="roleid">
                                            ...
                                            <option value="booker">Manager</option>
                                    ...
                                    <button class="btn btn-primary btn-block" tabindex="5" id="register"><span id="spin"></span>Sign up</button>
                                </form>
    ...
    <!-- BEGIN: Page JS-->
    <script src="assets/js/scripts/pages/page-auth-register.js"></script>
    <!-- END: Page JS-->
