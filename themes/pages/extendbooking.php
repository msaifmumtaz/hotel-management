                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="ex-total-payment" class="form-control" value="<?php echo $bookingdata["total_payment"]?>" readonly/>
                                                </div>
                                            </div>
                                            <div class="col-md-4 col-12">
                                                <div class="form-group">
                                                    <label for="ex-paid">Previous Paid</label>
                                                    <input type="text" id="ex-paid" class="form-control" value="<?php echo $bookingdata["paid"]?>" readonly/>
                                                </div>
                                            </div>
                                            <div class="col-md-4 col-12">
                                                <div class="form-group">
