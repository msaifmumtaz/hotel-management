        ...
        <div class="content-wrapper">
            ...
            <div class="content-body">
                ...
                <section id="dashboard-ecommerce">
                    <div class="text-center text-danger h2 mb-2 mt-4">Attention!</div>
                    <div class="text-center h3 text-white">You are not allowed to perform this action.<br> For more details contact your System Administrator.</div>
                    <div class="text-center mt-3">
                        <a class="text-center btn btn-primary" href="/admin/dashboard">Go Back to Dashboard</a>
                    </div>
